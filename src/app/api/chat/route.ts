...
export async function POST(req: Request) {
  ...
  const prompt = 'You are AI assistant that follows instructions very well. Based on this text generate multiple questions. Text: '; // The text you want to prepend

  const lastMessage = messages[messages.length - 1];
  
  // Modify the content of the last object
